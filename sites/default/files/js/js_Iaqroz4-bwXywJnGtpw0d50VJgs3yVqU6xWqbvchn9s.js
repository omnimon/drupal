...
/* global display */
  'use strict';
  $("#edit-settings-icon-placement-1, #edit-settings-use-default-style-ignore-colors,#edit-settings-font-size,#block-form,#edit-settings-icon-color,#edit-settings-button-link-color,#edit-settings-spacing, #edit-settings-radius, #edit-settings-size").click(function () {
    update_icons();
  });
